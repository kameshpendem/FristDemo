...
let path1;
class PersonAppointment extends Component {
  constructor(props) {
    super(props);
            ...
            RNFetchBlob.fetch(
              ...
              .then((resp) => {
                ...
                Alert.alert(
                  ...
                  i18n.t('PERSON_REGISTRATION.IMAGE_UPLOADED'),
                );
              })
              .catch((err) => {
                Alert.alert(
                  i18n.t('PERSON_REGISTRATION.ALERT'),
                  i18n.t('PERSON_REGISTRATION.IMAGE_NOT_UPLOADED'),
                );
              });
          }
        })
  ...
  onValueChangeIdtype = (value) => {
    ...
    this.setState({
      ...
      def_idtype_val1: idtype_val[0] + ' ' + idtype_val[1],
  ...
  onValueChangePhoneNumberSl(value) {
    this.setState({tempper_val_cng: true});
    if (value.length <= 3) {
      ...
      if (value.length >= 13) {
        ...
        global.phone = value.substring(3, 12);
  ...
  checkOTP = async () => {
    try {
      ...
      if (OtpResponse) {
        ...
        alert(i18n.t('PERSON_REGISTRATION.OTP_NOT_MATCHED'));
      }
    } catch (error) {
      alert(i18n.t('PERSON_REGISTRATION.OTP_NOT_MATCHED'));
    }
  ...
  askOTP = async () => {
    ...
    if (this.state.first_name == '') {
      this.setState({
        error1: i18n.t('PERSON_REGISTRATION.PLEASE_ENTER_FIRST_NAME'),
      });
    } else if (this.state.last_name == '') {
      this.setState({
        error2: i18n.t('PERSON_REGISTRATION.PLEASE_ENTER_LAST_NAME'),
      });
    }
    ...
    // }
      ...
      this.setState({
        error4: i18n.t('PERSON_REGISTRATION.PLEASE_ENTER_PHONE_NO'),
      });
    } else {
      try {
        ...
        let response = await axios.post(url2, payload, {
          headers: {
            Accept: 'application/json',
            'Content-Type': 'application/json',
          },
        ...
        alert(i18n.t('PERSON_REGISTRATION.OTP_MOBILE'));
      }
  ...
  goSubmit = async () => {
    ...
    } else if (this.state.phonecode == 'in') {
      if (phone.length != 10) {
        alert(i18n.t('PERSON_REGISTRATION.MORE_THAN_10'));
      }
    } else if (this.state.phonecode == 'sl') {
      if (phone.length != 9) {
        alert(i18n.t('DOCTOR_REGISTER.PHONE_NO_NINE'));
      }
    } else if (!phonecode) {
          ...
          if (response != 1 || response.length > 0) {
            Alert.alert(
              ...
              [
                ...
                {
                  text: i18n.t('PERSON_REGISTRATION.CANCEL'),
          ...
          <Row>
            <Col>
              ...
              <TouchableOpacity
                ...
                {/* <NativeBaseImage
                  source={{
                    uri: getApiUrl() + this.state.personImag,
                  }}
                  alt="Alternate Text"
                  size="xl"
                /> */}
          ...
          <Row>
            <Col size={40}>
              ...
              accessibilityLabel="saluationLabel">
                {i18n.t('PERSON_REGISTRATION.SALUTATION')}{' '}
              ...
              <Picker
                ...
                iosIcon={
                  <Icon2
                  testID="salutationPickerIcon"
                  accessibilityLabel="salutationPickerIcon"
                ...
                <Picker.Item
                 testID="salutationPicker"
                 accessibilityLabel="salutationPicker"
                  label={i18n.t('PERSON_REGISTRATION.MR')}
                  value="Mr"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.MS')}
                  value="Ms"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.MRS')}
                  value="Mrs"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.MASTER')}
                  value="Master"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.BABY')}
                  value="Baby"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.BABY_OF')}
                  value="Baby_of"
                />
                <Picker.Item
                  label={i18n.t('PERSON_REGISTRATION.DR')}
                  value="Dr"
                />
              </Picker>
            ...
            <Col size={70}>
              ...
              {!this.state.firstNameValidate ? (
                ...
                accessibilityLabel="pleaseEnterAlphabetsText">
                  {' '}
                  *{i18n.t('PERSON_REGISTRATION.PLEASE_ENTER_ALPHA_BETS')}{' '}
                </Text>
              ) : null}
            </Col>
          </Row>
              ...
              <Col size={48}>
                ...
                {!this.state.middleNameValidate ? (
                  <Text
                    ...
                    {' '}
                    *{i18n.t(
                      'PERSON_REGISTRATION.PLEASE_ENTER_ALPHA_BETS',
                    )}{' '}
                  </Text>
                ) : null}
              </Col>
            ...
            <Row>
              <Col size={25}>
                <Label
                  ...
                  {i18n.t('PERSON_REGISTRATION.BLOOD_GROUP')}
                  <Text style={styles.TextStyle}>*</Text>
                </Label>
                <Picker
                testID="bloodGroupSelectPicker"
                accessibilityLabel="bloodGroupSelectPicker"
                  selectedValue={this.state.blood_group}
                  iosIcon={
                    <Icon2
                    testID="downIcon3"
                    accessibilityLabel="downIcon3"
                      style={{marginRight: 40, top: -5}}
                      name="sort-down"
                      color="#a9a9a9"
                    />
                  ...
                  <Picker.Item
                    label={i18n.t('PERSON_REGISTRATION.SELECT')}
                    value=""
                  />
                  ...
                  <Picker.Item
                    label={i18n.t('PERSON_REGISTRATION.NOT_KNOWN')}
                    value="NOT KNOWN"
                  />
                </Picker>
                <Icon
              ...
              <Col size={25}>
                ...
                accessibilityLabel="genderLabel"
                  ...
                  {i18n.t('PERSON_REGISTRATION.GENDER')}{' '}
                  <Text style={styles.TextStyle}>*</Text>
                </Label>
                <Picker
                testID="genderPicker"
                accessibilityLabel="genderPicker"
                  ...
                  />
                  <Picker.Item
                    label={i18n.t('PERSON_REGISTRATION.MALE')}
                    value="male"
                  />
                  <Picker.Item
                    label={i18n.t('PERSON_REGISTRATION.FEMALE')}
                    value="female"
                  />
                  <Picker.Item
                    label={i18n.t('PERSON_REGISTRATION.OTHERS')}
                    value="others"
                  />
                </Picker>
                <Icon
              ...
              <Col
                ...
                {Platform.OS === 'android' ? (
                  <View style={{marginLeft: 10}}>
                    <DatePicker
                    testID="datePickerText"
                    accessibilityLabel="datePickerText"
                      allowFontScaling={false}
                      maxDate={new Date()}
            ...
            <Col>
              {this.state.phonecode == 'in' ? (
                ...
                accessibilityLabel="phoneNumberTextInput"
                  ...
                  value={this.state.phonecode + this.state.phone_no}
                  onChangePhoneNumber={(text) => {
                    this.onValueChangePhoneNumberSl(text);
                  }}
                  maxLength={9}
                />
              )}
    ...
    />  */}
              ...
              {this.state.phoneemptyvalidate ? (
                <Text
                  ...
                  testID="phoneNumberNotEmptyText"
                  accessibilityLabel="phoneNumberNotEmptyText">
                  {' '}
                  *{i18n.t(
                    'PERSON_REGISTRATION.PHONE_NUMBER_IS_NOT_EMPTY',
                  )}{' '}
                </Text>
              ) : null}
              {this.state.phonecode == 'in' ? (
                ...
                <Text
                  ...
                  {' '}
                  {i18n.t('DOCTOR_REGISTER.PHONE_NO_NINE')}
                </Text>
              ) : null}
            </Col>
          </Row>
            ...
            <Row>
              <Col size={40}>
                ...
                accessibilityLabel="idTypeLabel"
                  ...
                  {i18n.t('PERSON_REGISTRATION.ID_TYPE')}
                  <Text style={styles.TextStyle}>*</Text>
                </Label>
                <Picker
                  ...
                  iosIcon={
                    <Icon2
                    testID="idTypeDropDown"
                    accessibilityLabel="idTypeDropDown"
                      style={{marginRight: 40, top: -5}}
                      name="sort-down"
                      color="#a9a9a9"
                    />
              ...
              <Col size={60}>
                ...
                {!this.state.idtype_numberValidate ? (
                  ...
                  accessibilityLabel="enterValidIdText">
                    ...
                    *
                    {i18n.t(
                      'PERSON_REGISTRATION.PLEASE_ENTER_VALID_ID_NUMBER',
                    )}{' '}
                  </Text>
                ) : null}
              </Col>
              ...
              <Col size={this.state.otpsent ? 50 : 90}>
                ...
                accessibilityLabel="otpButton"
                  ...
                  accessibilityLabel="otpText">
                    {!this.state.otpsent
                      ? i18n.t('PERSON_REGISTRATION.GENERATE_OTP')
                      : i18n.t('PERSON_REGISTRATION.RESEND_OTP')}
                  </Text>
                </Button>
              </Col>
...
export default connect(mapStateToProps, {getPostList})(PersonAppointment);
